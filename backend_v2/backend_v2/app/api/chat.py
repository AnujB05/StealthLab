...
from app.api.deps import enforce_limits, get_scope
...
async def ask(
    ...
    # The retriever carries the scope, so an answer can only ever be
    # grounded in nodes this viewer is allowed to see.
    service = ChatService(
        pool,
        AnthropicAgent(agent_id="chat"),
